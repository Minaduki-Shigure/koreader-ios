...
require_source "${INPUT}" 'local function waitForEvent(sec, usec)'
require_source "${INPUT}" 'ok, ev, timerfd = waitForEvent(sec, usec)'
require_source "${INPUT}" 'ok, ev = waitForEvent(sec, usec)'
